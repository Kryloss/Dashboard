...
export function SleepDialog({ open, onOpenChange, onSleepLogged }: SleepDialogProps) {
    ...
    const addNapSession = () => {
        ...
        const newSession: SleepSession = {
            id: `nap-${Date.now()}`,
            startTime: 13 * 60, // 1 PM default
            endTime: 14 * 60, // 2 PM default
            wakeUps: 0,
            type: 'nap'
        }
    ...
    // Generate timeline markers (every 2 hours from 12 AM to 12 PM)
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="relative">
                            <div className="flex justify-between text-xs text-[#A1A1AA] mb-2">
                                {timelineMarkers.map(marker => (
                                    <span key={marker.minutes}>{marker.label}</span>
                                ))}
                            </div>

                            {/* Timeline line */}
                            <div className="w-full h-1 bg-[#2A2B31] rounded-full mb-4"></div>
                        </div>
                        ...
                        <div className="space-y-3">
                            {sleepSessions.map((session) => {
                                ...
                                return (
                                    <div key={session.id} className="bg-[#121318] border border-[#212227] rounded-lg p-4">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div className="flex justify-between text-xs text-[#A1A1AA]">
                                                ...
                                                <Button
                                                    ...
                                                    variant="ghost"
                                                    className="text-xs h-auto p-1 text-[#A1A1AA] hover:text-[#F3F4F6]"
                                                >
                                                    + Wake-up
                                                </Button>
