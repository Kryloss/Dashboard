...
export function ActivityItem({
    ...
    return (
        <div className={cn(
            "flex items-center space-x-3 py-2 px-4 bg-[#0E0F13] border border-[#212227] rounded-[16px] mb-2 last:mb-0",
            ...
            <div className="flex-1 min-w-0">
                ...
                <h3 className="font-medium text-[#F3F4F6] text-sm truncate">{name}</h3>
                ...
                <div className="flex items-center justify-between">
                    ...
                    {/* Progress Bar - inline */}
                    <div className="w-16 h-1 bg-[rgba(255,255,255,0.08)] rounded-full overflow-hidden ml-2">
                        <div
