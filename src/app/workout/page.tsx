...
import { Settings, Plus, Flame, Dumbbell, User, Timer, Bike, Target, TrendingUp, Clock, Heart, FileText, Play, Edit3, Trash2, Moon, Run } from "lucide-react"
                                            ...
                                            {recentActivities.map((activity) => {
                                                const getWorkoutIcon = (type: string) => {
                                                    switch (type) {
                                                        ...
                                                        case 'running': return <Run className="w-4 h-4" />
