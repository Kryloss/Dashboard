...
export function HealssNav() {
    ...
    const tabs = [
        { name: "Workout", href: "/", isActive: pathname === "/healss" },
        { name: "Nutrition", href: "/nutrition", isActive: pathname === "/healss/nutrition" },
        { name: "Progress", href: "/progress", isActive: pathname === "/healss/progress" }
    ]
