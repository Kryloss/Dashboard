...
-- ================================
-- STEP 6: Optional: Sample data for testing (remove in production)
-- ================================
...
/*
INSERT INTO progress_images (user_id, image_url, image_type, title, notes, weight_kg, visibility) VALUES
(
    'your-user-id-here', 
    'https://your-supabase-url.supabase.co/storage/v1/object/public/progress-images/your-user-id-here/sample-before.jpg',
    'before',
    'Starting Point',
...
(
    'your-user-id-here',
    'https://your-supabase-url.supabase.co/storage/v1/object/public/progress-images/your-user-id-here/sample-progress.jpg', 
    'progress',
    '3 Month Progress',
